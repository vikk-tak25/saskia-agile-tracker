...
**What to improve next:** CI, branch protection, and PR template are all in place. The remaining gap is lint — adding ESLint would catch style and runtime errors that the current test suite does not exercise.
